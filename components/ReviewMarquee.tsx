...
function ReviewCard({ name, handle, text, avatar }: typeof testimonials[0]) {
  return (
    <div className="w-[350px] md:w-[400px] p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md text-white flex flex-col gap-5 shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:bg-white/10 transition-colors group cursor-default">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[#00f3ff] text-sm mt-1">{handle}</span>
        </div>
      </div>
      <p className="text-white/70 leading-relaxed italic text-lg whitespace-normal">
        "{text}"
      </p>
    </div>
  );
